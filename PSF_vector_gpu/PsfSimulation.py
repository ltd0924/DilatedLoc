...
class PsfSimulation:
    ...
    def __init__(self,psf_pars,type):
        self.psf = CDLL("D://users/feiyue\Dilatedloc_finall\PSF_vector_gpu\psf_simu_gpu.dll", winmode=0)
    ...
    def sim_psf_vector(self, X_os, Y_os, Z):
        ...
        sP.wavelengthX_ = self.psf_pars['wavelength']
        ...
        zernikeModes[2, :] = zernikeModes[2, :] * sP.wavelengthX_
